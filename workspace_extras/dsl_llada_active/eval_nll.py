...
Usage:
    python dsl_llada/eval_nll.py --checkpoint ./checkpoints/dsl_1000step/checkpoint-1000 --gpu 0
    python dsl_llada/eval_nll.py --checkpoint GSAI-ML/LLaDA-8B-Instruct --gpu 1  # baseline (no DSL)
"""
import argparse
import json
import math
...
from dsl_modules import noisy_embedding, attach_dsl_modules
