...
Usage:
    python dsl_llada/compute_bertscore_summarization.py \
        --files eval_results/summarization/xsum_b1_sde_nfe64.json
    python dsl_llada/compute_bertscore_summarization.py --pattern "xsum_*_nfe64.json"
    python dsl_llada/compute_bertscore_summarization.py --all --gpu 0
"""
import argparse
import glob
import json
