...
# Usage:
#   bash dsl_llada/eval_sum_shard_launch.sh <dataset> <n> <method_args...>
# Example (SDE NFE=64 on XSum 1000):
#   bash dsl_llada/eval_sum_shard_launch.sh xsum 1000 \
...
for i in 0 1 2 3 4 5 6 7; do
  ...
  /home/ubuntu/efs/RMDM/.venv/bin/python dsl_llada/eval_summarization.py \
