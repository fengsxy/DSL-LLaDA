...
# ============================================================
# Usage:
#   bash dsl_llada/scripts/eval_sde_gen_formal.sh part1     # Standard benchmarks
#   bash dsl_llada/scripts/eval_sde_gen_formal.sh part2a    # NFE curve
#   bash dsl_llada/scripts/eval_sde_gen_formal.sh part2b    # Long-form gen
#   bash dsl_llada/scripts/eval_sde_gen_formal.sh part2c    # Diversity (Self-BLEU)
#   bash dsl_llada/scripts/eval_sde_gen_formal.sh part2d    # Speed-quality
#   bash dsl_llada/scripts/eval_sde_gen_formal.sh metrics   # Compute all metrics
#   bash dsl_llada/scripts/eval_sde_gen_formal.sh all       # Everything
#
...
SCRIPT="dsl_llada/eval/eval_sde_gen_formal.py"
