...
#
# Usage:
#   bash dsl_llada/scripts/run_all_experiments.sh          # Run all
#   bash dsl_llada/scripts/run_all_experiments.sh status    # Check progress
#
...
BLOCK_SDE="dsl_llada/eval/eval_block_sde.py"
...
log ""
log "Monitor with: bash dsl_llada/scripts/run_all_experiments.sh status"
log "Logs in: $LOGDIR/"
