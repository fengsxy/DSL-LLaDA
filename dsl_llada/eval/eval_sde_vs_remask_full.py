...
Usage:
    ...
    python dsl_llada/eval/eval_sde_vs_remask_full.py --mode sde --gpu 6

    # Remask configs on GPU 7
    python dsl_llada/eval/eval_sde_vs_remask_full.py --mode remask --gpu 7

    # Just compute metrics on existing generated texts
    python dsl_llada/eval/eval_sde_vs_remask_full.py --mode metrics --gpu 6
"""
import argparse
import json
import math
