...
Usage:
    CUDA_VISIBLE_DEVICES=2 python dsl_llada/eval/absorbing_sde.py --gpu 0
"""
...
def main():
    ...
    ckpt_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), CKPT)
    gsm8k_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), GSM8K_PATH)
