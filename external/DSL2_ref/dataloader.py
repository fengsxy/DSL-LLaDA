# Dataloader from https://github.com/s-sahoo/duo/blob/main/dataloader.py
# Minimally edited to match local configs
import functools
import itertools
import json
import math
...
def get_dataloaders(config, tokenizer, skip_train=False,
    ...
    # assert (config.train.global_batch_size
    #         == (config.train.batch_size
    #             * config.trainer.num_nodes
    #             * num_gpus
    #             * config.train.grad_accum_steps))
    # if config.train.global_batch_size % (
    #         num_gpus * config.train.grad_accum_steps) != 0:
    #     raise ValueError(
    #         f'Train Batch Size {config.training.batch_size}'
    #         f'not divisible by {num_gpus} gpus with accumulation '
    #         f'{config.train.grad_accum_steps}.')
    # if config.train.eval_global_batch_size % num_gpus != 0:
    #     raise ValueError(
